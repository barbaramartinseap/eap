...
INSERT INTO "new_Lead" ("createdAt", "diasParado", "estagioPipeline", "id", "nichoObra", "nomeContato", "nomeEmpresa", "origem", "qtdObrasSimultaneas", "scoreIcp", "telefone", "temperatura", "unidadeId", "updatedAt") SELECT "createdAt", "diasParado", "estagioPipeline", "id", "nichoObra", "nomeContato", "nomeEmpresa", "origem", "qtdObrasSimultaneas", "scoreIcp", "telefone", "temperatura", "unidadeId", "updatedAt" FROM "Lead";
DROP TABLE "Lead";
